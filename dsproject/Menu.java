...
public class Menu extends javax.swing.JFrame {
    ...
    public void readData(){
             ...
             try {
                File myObj = new File("C:\\Users\\HP\\Documents\\NetBeansProjects\\DSProject\\src\\dsproject\\Data\\teachersData.txt");
                Scanner myReader = new Scanner(myObj);
                int i = 0;
                int j = 0;
                while(myReader.hasNextLine()) {
             ...
             try {
                File myObj = new File("C:\\Users\\HP\\Documents\\NetBeansProjects\\DSProject\\src\\dsproject\\Data\\coursesData.txt");
                Scanner myReader = new Scanner(myObj);
                int i = 0;
                while(myReader.hasNextLine()) {
    ...
    public Comments createRandomCommentObj(String[] comments){
        ...
        comment.insertionSort(); //if we werent creating random comments and creating different linkedlist each time, we would only need to use insertion sort when go back button is pressed on display rating menu
        return comment;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      //  rating.comments.sortListAccordingToUpvotes();
        if(rating==null){
